        ...
        <section className="mx-auto bg-black text-white relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center z-10">
            <div className="flex flex-col justify-center items-center">
              {/* Circular button */}
              <span className="bg-red-500 text-xs py-2 px-4 mb-12 font-raleway font-bold rounded-full  items-center justify-center">
                <span className="mr-2 w-2.5 h-2.5  bg-red-700 rounded-full"></span>
                OUR PRODUCTS
              </span>
              <h1 className="text-4xl text-center font-raleway sm:text-5xl lg:text-6xl font-bold">
              Go Further with Behrupiya
            </h1>

            <div className="text-gray-400 text-sm md:text-base m-8 justify-center font-raleway font-semibold text-center lg:w-full  max-w-2xl">
