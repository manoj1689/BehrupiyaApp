...
export default function Header() {
  ...
  return (
    <header className="w-full  py-4  flex justify-between items-center shadow-md border-b border-white bg-gradient-to-b from-gray-900 to-black">
      {/* Left: Logo */}
      <div className="flex w-2/5  sm:w-1/3 px-4  md:w-1/4 justify-center items-center">
        <Link href="/" passHref>
          <Image
            src={BehrupiyaLogo}
            alt="User Profile"
      ...
      <div className="flex justify-end  max-sm:mr-2 sm:mr-6  md:justify-center  items-center w-3/5 sm:w-2/3  md:w-1/4">
